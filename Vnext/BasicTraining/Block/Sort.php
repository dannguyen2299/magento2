...
//
//    if ($studentSort == 1) {
//        $result = $this->postFactory->create()->getCollection()->setOrder('entity_id', 'DESC');
//
//    } else if ($studentSort == 2) {
//        $result = $this->postFactory->create()->getCollection()->setOrder('name', 'DESC');
//
//    } else if ($studentSort == 3) {
//        $result = $this->postFactory->create()->getCollection()->setOrder('Dob', 'DESC');
//
//    }
//    return $result;
//
